...
/**
 * Clase que implementa el modelo de Contenedor Estandar. Este mantiene las características
 * de {@link Contenedor} y la diferencia de los otros modelos es que este es capaz de ser 
 * transportado por cualquier medio de transporte, ocupa un nivel de una plaza y tiene techo.
 * @see Contenedor
